...
double const jet1_ptminvbf=30.0; // We cut on all jets below 50 GeV
double const jet2_ptminvbf=30.0; // We cut on all jets below 50 Ge
double const bjetpt = 20;
...
double const tolerance=20;
double const toleranceX=2;
